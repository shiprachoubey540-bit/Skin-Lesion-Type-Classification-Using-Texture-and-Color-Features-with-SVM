...
def load_assets():
    try:
        ...
        return {"SVM": svm, "XGBoost": xgb}, scaler
    except FileNotFoundError:
        st.error("Model files missing in 'models/' directory. Double-check your fork paths.")
        return None, None
...
def extract_features(img_input):
    ...
    # Clean alignment mapping to your 70 extracted features
                ...
                with st.spinner('Analyzing...'):
                    ...
                    with col_right:
                        ...
                        radar_fig.update_layout(
                            polar=dict(bgcolor="rgba(0,0,0,0)", radialaxis=dict(visible=True, showticklabels=False)), 
